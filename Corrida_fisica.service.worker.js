...
/** @type {string} */
const CACHE_VERSION = '1779711089|1130413162';
/** @type {string} */
const CACHE_PREFIX = 'Corrida fisica-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Corrida_fisica.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Corrida_fisica.html","Corrida_fisica.js","Corrida_fisica.offline.html","Corrida_fisica.icon.png","Corrida_fisica.apple-touch-icon.png","Corrida_fisica.audio.worklet.js","Corrida_fisica.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Corrida_fisica.wasm","Corrida_fisica.pck"];
